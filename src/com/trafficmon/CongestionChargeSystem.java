...
public class CongestionChargeSystem implements TransactionHandler{
    ...
    private static AccountsService accountsService = RegisteredCustomerAccountsService.getInstance();
    private static PenaltiesService penaltiesService = OperationsTeam.getInstance();
    ...
    public static void setAccountsService(AccountsService newAccountsService){
        accountsService = newAccountsService;
    }
    public static void setPenaltiesService(PenaltiesService newPenaltiesService){
    ...
    /* Charge Calculation and Returning Methods*/
    /**
    ...
    public Map<Vehicle, BigDecimal> getChargeList(){
        ...
        for(Vehicle vehicle: crossingsPerVehicle.keySet()){
            ...
            if (!checkOrderingOf(crossingsByVehicle)) {
    ...
    /* Account Manipulation / ChargeSystem Methods */
    /**
    ...
    /**
     * Handles all transactions and handles any errors thrown by their processes. Overrides the method from {@link TransactionHandler}.
     * Uses the static {@link AccountsService} and {@link PenaltiesService} in the system
     * @param object refers to the {@link Vehicle} in this case.
     */
    @Override
    public void executeTransaction(Object object){
        Vehicle vehicle = (Vehicle) object;
        BigDecimal charge = getChargeForVehicle(vehicle);
        try {
