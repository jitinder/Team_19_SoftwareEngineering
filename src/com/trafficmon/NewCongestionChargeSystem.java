...
public class NewCongestionChargeSystem {
    ...
    public Map<Vehicle, List<ZoneBoundaryCrossing>> getter_for_getCrossingsPerVehicle() {
        return getCrossingsPerVehicle();
    }
    ...
    public static void main(String args[]){
        ...
        vehicles.add(0, Vehicle.withRegistration("A123 XYZ"));
        vehicles.add(1,Vehicle.withRegistration("J091 4PY"));
        vehicles.add(2, Vehicle.withRegistration("B246 XYZ"));
        vehicles.add(3, Vehicle.withRegistration("C783 4TT"));
        vehicles.add(4, Vehicle.withRegistration("D243 5PR"));
